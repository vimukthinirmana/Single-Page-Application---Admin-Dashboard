...
export default function Header() {
  return (
    <header className="fixed bg-[#ffffff] w-full z-6 px-4 shadow-md  shadow-slate-300 pl-[20rem]">
      ...
      <div className="flex flex-wrap items-center justify-between h-16">
        ...
        <div className="relative  p-0 ">
          <div className="relative max-w-sm mx-auto  flex items-center justify-center ">
            <input className="w-96 h-9 py-2 px-3 border border-none bg-slate-50 rounded-md  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="search" placeholder="Search for..." ></input>
        ...
        <div className="relative flex flex-wrap justify-center lg:justify-start items-center">
